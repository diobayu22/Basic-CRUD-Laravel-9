...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('blog/assets/css/styles.css') }}">
...
<body>
    ...
    <script src="{{ asset('admin/assets/https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/js/bootstrap.bundle.min.js') }}">
    </script>
